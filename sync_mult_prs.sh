...
./sync_pr.sh preview/pingcap/docs/"https://github.com/pingcap/docs/pull/20463"
./sync_pr.sh preview/pingcap/docs-cn/"https://github.com/pingcap/docs-cn/pull/19962"
